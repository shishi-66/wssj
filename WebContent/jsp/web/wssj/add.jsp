...
<form id="form1">
	...
	<div class="form-tools">
		<button type="button" class="btn btn-success" onclick="save33('bc');return false;">保存退出</button>
		<button type="button" class="btn btn-success" onclick="save33('tj');return false;">保存并提交</button>
	</div>
</form>
<!-- 弹出框 -->
