	...
	<div class="j_form">
		...
		<div class="j_form_items">
			...
			<div class="j_form_item j_form_item--table">
				...
				<div class="j_form_item__control">
					<div class="j_input--mc" onclick="popRadioCustom('prodCatCode','prodCatCode_name',jsonCplb,$('#prodCatCode').val(),'1')">
						<div class="j_input__control">
							<input type="text" id="prodCatCode_name" readonly="readonly" placeholder="请选择产品类别，必填" />
			...
			<div class="j_form_item j_form_item--table">
				...
				<div class="j_form_item__control">
					<div class="j_input--mc" >
						<div class="j_input__control">
							<input type="text" name="inspSampGrade" value="${obj.inspSampGrade}" id="inspSampGrade" placeholder="请输入或选择质量等级" />
						</div>
						<div class="j_input__btn">
			...
			<div class="j_form_item j_form_item--table">
				...
				<div class="j_form_item__control">
					<div class="j_input--mc" onclick="popRadioCustom('inspSampSafeCategory','',jsonAqlbData,$('#inspSampSafeCategory').val(),'1')">
						<div class="j_input__control">
							<input type="text" name="inspSampSafeCategory" value="${obj.inspSampSafeCategory}" id="inspSampSafeCategory" readonly="readonly" placeholder="请选择安全类别" />
						</div>
						<div class="j_input__btn">
							<button type="button" class="j_but--select"><span class="fa fa-caret-down"></span></button>
						</div>				
		...
		<div class="j_form_item j_form_item--table">
			...
			<div class="j_form_item__control">
				<div class="j_input--mc">
					<div class="j_input__control">
						<input type="text" name="inspSampTrademark" value="${obj.inspSampTrademark}" id="inspSampTrademark" placeholder="请输入" />
					</div>
				</div>
			</div>
		</div>
							...
							<div class="j_input j_input--label">
								<div class="j_input__control">
									<div class="j_input--mc" onclick="popRadioCustom('inspSampGoods','',jsonHhkhData,$('#inspSampGoods').val(),'1')">
										<div class="j_input__control">
											<input type="text" name="inspSampGoods" id="inspSampGoods" readonly="readonly" placeholder="" value="${obj.inspSampGoods}"/>
										</div>
										<div class="j_input__btn">
											<button type="button" class="j_but--select"><span class="fa fa-caret-down"></span></button>
										</div>				
				...
				<div class="mui-col-sm-9 mui-col-xs-9">
					<div class="j_form_item j_form_item--table j_form_item--noborder">
						<div class="j_form_item__control">
							<div class="j_input">
								<div class="j_input__control">
									<input type="text" name="inspSampGoodsNum" id="inspSampGoodsNum" value="${obj.inspSampGoodsNum}" placeholder="请输入批号/货号/款号" />
								</div>
							</div>
						</div>
					</div>
		...
		<div class="j_form_items">
			<div class="j_form_items__hd">
				...
				<div class="j_form_items__addon j_form_items__addon--absolute">
					<button type="button" class="j_but--input_addon" onclick="copyEnte('sjdw','scdw')">同委托单位</button>
				</div>
			</div>
			<div class="j_form_items__bd">
				<div class="j_form_item j_form_item--table">
					...
					<div class="j_form_item__control">
						<div class="j_input">
							<div class="j_input__control">
								<input type="text" name="scdwName" id="scdwName" value="${obj.scdwName}" />
							</div>
						</div>
					</div>
				</div>
		...
		<div class="j_form_items">
			...
			<div class="j_form_items__bd">
				<input type="hidden" name="inspSampStandard" id="inspSampStandard" value="${obj.inspSampStandard}"/>
		...
		<div class="j_form_items">
			...
			<div class="j_form_items__bd">
				<input type="hidden" name="inspSampItem" id="inspSampItem" value="${obj.inspSampItem}"/>
						...
						<div class="j_form_item__control">
							<div class="j_input--mc">
								<div class="j_input__control" onclick="popRadioCustom('inspSampRemaining','',jsonYyclData,$('#inspSampRemaining').val(),'1')">
									<input type="text" name="inspSampRemaining" id="inspSampRemaining" readonly="readonly" value="${obj.inspSampRemaining}" />
								</div>
								<div class="j_input__btn">
									<button type="button" class="j_but--select"><span class="fa fa-caret-down"></span></button>
								</div>				
					...
					<div class="j_form_item j_form_item--type--ud">
						...
						<div class="j_form_item__control">
							<div class="j_input--mc" onclick="popRadioCustom('inspSampReportReceive','',jsonBglqData,$('#inspSampReportReceive').val(),'1')">
								<div class="j_input__control">
									<input type="text" name="inspSampReportReceive" id="inspSampReportReceive" readonly="readonly" value="${obj.inspSampReportReceive}" />
								</div>
								<div class="j_input__btn">
									<button type="button" class="j_but--select"><span class="fa fa-caret-down"></span></button>
								</div>				
				...
				<div class="mui-col-sm-6 mui-col-xs-6">		
					<div class="j_form_item j_form_item--table j_form_item--noborder">
						...
						<div class="j_form_item__control">
							<div id="isDxpd_name" 
<c:choose>
<c:when test="${obj.isDxpd!=null and obj.isDxpd=='1'}">class="mui-switch mui-active"</c:when>
				...
				<div class="mui-col-sm-6 mui-col-xs-6">						
					<div class="j_form_item j_form_item--table j_form_item--noborder">
						...
						<div class="j_form_item__control">
							<div id="isZhpd_name" 
<c:choose>
<c:when test="${obj.isZhpd!=null and obj.isZhpd=='1'}">class="mui-switch mui-active"</c:when>
<c:otherwise>class="mui-switch"</c:otherwise>
</c:choose> />
								<div class="mui-switch-handle"></div>
							</div>
		...
		<div class="j_form_items">
			...
			<div class="j_form_item j_form_item--type--ud j_form_item--noborder">
				<div class="j_form_item__label">退回原因：${obj.returnReson}</div>
			</div>
			</c:if>
		</div>
		<div class="j_form__tools--submit">
			<button type="button" class="mui-btn mui-btn-success" onClick="save('bc');return false;">保存并退出</button>
			<button type="button" class="mui-btn mui-btn-primary" onClick="save('tj');return false;">保存并送受理</button>
		</div>
		</form>
