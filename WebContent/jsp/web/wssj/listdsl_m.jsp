...
var urlEdit="<%=request.getContextPath()%>/webSample/toOpen.do?op=dsl&key="; //未提交
...
function toGetDataList() {
	...
	if(json.hasOwnProperty("records")){
		...
		for (var i = 0;i < json.rows.length; i++) {
			...
			html+="<div class='mui-col-sm-4 mui-col-xs-6'><div class='j_dl--show01'><div class='j_dd--block'><strong>"+rq+"</strong></div><div class='j_dt--block'>寄样日期</div></div></div>";			
			html+="<div class='mui-col-sm-4 mui-col-xs-6'><div class='j_dl--show01'><div class='j_dd--block'>"+(d.hasOwnProperty("inspSampExpressNum")?d.inspSampExpressNum:"")+"</div><div class='j_dt--block'>快递单号</div></div></div>";			
			html+="</div>";
			html+="</div>";
